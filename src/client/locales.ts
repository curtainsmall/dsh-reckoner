...
const zh = {
  ...
  articlePreview: 'Markdown 文章预览',
  articlePreviewTex: 'LaTeX 文章预览',
  articleCopy: '复制',
  articleCopied: '已复制',
  articleDownload: '下载',
  markerQuestion: '问题',
...
const en: Record<keyof typeof zh, string> = {
  ...
  articlePreview: 'Markdown article preview',
  articlePreviewTex: 'LaTeX article preview',
  articleCopy: 'Copy',
  articleCopied: 'Copied',
  articleDownload: 'Download',
