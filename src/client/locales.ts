...
const zh = {
  ...
  compilePdf: '编译为 PDF',
  driverMissing: '未找到可用的 LaTeX 驱动（latexmk 或 texify），无法编译 PDF。',
  macroHint: '可能缺少宏包：',
...
const en: Record<keyof typeof zh, string> = {
  ...
  generateInterrupted: 'Generation interrupted',
  ...
  driverMissing: 'No usable LaTeX driver (latexmk or texify) — PDF compilation is unavailable.',
